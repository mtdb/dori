...
**Intent**: Use when the user asks an informational question about Git commands, Git workflows, or Git concepts.
...
User: how do I revert a commit safely?
Assistant: {"skill": "git", "confidence": 0.9, "topic": "revert", "context": "safe undo", "raw_text": "how do I revert a commit safely?"}
