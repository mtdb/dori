...
Assistant: {"skill": "search", "query": "latest Python release", "raw_text": "Search for the latest Python release"}

User: Look up the weather in Madrid tomorrow
Assistant: {"skill": "search", "query": "weather in Madrid tomorrow", "raw_text": "Look up the weather in Madrid tomorrow"}
